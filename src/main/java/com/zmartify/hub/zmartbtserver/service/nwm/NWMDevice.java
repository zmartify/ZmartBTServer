...
public class NWMDevice implements INWMDevice {
	...
	public void startup() throws Exception {
		...
		nwmDevice = (Device) dbusConnection.getRemoteObject(DBUS_NETWORKMANAGER, deviceObjectPath,
				Device.class);

		log.debug("Got device '{}'", nwmDevice);

		nwmDeviceProperties = (Properties) dbusConnection.getRemoteObject(DBUS_NETWORKMANAGER, deviceObjectPath,
				Properties.class);
